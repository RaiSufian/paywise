...
const WelcomeNote = () => {
    ...
    const getData = async () => {
        ...
        await axios.get("index.php?action=get_page_widgets&wid_params=welcome_to_paywize")
            ...
            .catch((error) => {
                console.log("welcome error is", error)
                            ...
                            <div className="lg:flex items-center">
                                ...
                                <div className="lg:w-6/12 welcomebg">
                                    ...
                                    <div className="p-1 md:p-8 lg:p-10">
                                        ...
                                        <div data-aos="fade-up" data-aos-delay="1000" data-aos-duration="1000" className="pt-4 pb-1 text-justify">
                            ...
                            <ul>
                                ...
                                <li className="flex items-start gap-2 pt-3" data-aos="fade-up" data-aos-delay="1600" data-aos-duration="1000">
                                    ...
                                    <span>Thousands of contractors have achieved their financial goals with our support</span>
                                        ...
                                        <div className="mt-5 flex justify-end uppercase" data-aos="fade-bottom" data-aos-delay="500" data-aos-duration="1000">
