                    ...
                    <div className="w-6/12 welcomebg">
                        <div className="m-20">
                            ...
                            <ul>
                                ...
                                <li className="flex items-center gap-2 pt-3" data-aos="fade-up" data-aos-delay="2000" data-aos-duration="1000">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="text-green-500" width="1em" height="1em" viewBox="0 0 512 512"><path fill="currentColor" d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z" /></svg>
                                    <span>Officia quaerat eaque neque</span>
                                </li>
                                <li className="flex items-center gap-2 pt-3" data-aos="fade-up" data-aos-delay="2500" data-aos-duration="1000">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="text-green-500" width="1em" height="1em" viewBox="0 0 512 512"><path fill="currentColor" d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z" /></svg>
                                    <span>Officia quaerat eaque neque</span>
                                </li>
                                <li className="flex items-center gap-2 pt-3" data-aos="fade-up" data-aos-delay="3000" data-aos-duration="1000">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="text-green-500" width="1em" height="1em" viewBox="0 0 512 512"><path fill="currentColor" d="M17.47 250.9C88.82 328.1 158 397.6 224.5 485.5c72.3-143.8 146.3-288.1 268.4-444.37L460 26.06C356.9 135.4 276.8 238.9 207.2 361.9c-48.4-43.6-126.62-105.3-174.38-137z" /></svg>
                                    <span>Officia quaerat eaque neque</span>
                                </li>
                            </ul>
                            <div className="mt-5 flex justify-end uppercase" data-aos="fade-left" data-aos-delay="3000" data-aos-duration="1000">
