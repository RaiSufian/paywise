...
const OurServices = () => {
  ...
  const getData = async () => {
    await axios.get("index.php?action=get_page_widgets&wid_params=paywize_services")
      .then((resp) => {
        ...
        <div className="container mx-auto lg:pb-10">
          <div className="flex flex-wrap items-center">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2 pt-4 lg:pt-0">
              ...
              <h2 className="py-3 md:py-4 font-bold text-2xl md:text-4xl text-stone-900"> {data?.wid_heading} </h2>
